...
class SendViewController: UIViewController {
    ...
    // swiftlint:disable:next implicitly_unwrapped_optional
    var synchronizerNonAsync: SynchronizerNonAsync!
    ...
    override func viewDidLoad() {
        ...
        synchronizerNonAsync = SDKSynchronizerNonAsync(synchronizer: AppDelegate.shared.sharedSynchronizer)
        let tapRecognizer = UITapGestureRecognizer(target: self, action: #selector(viewTapped(_:)))
        self.view.addGestureRecognizer(tapRecognizer)
        setUp()
        
        synchronizerNonAsync.prepare(
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        synchronizerNonAsync.start(retry: false) { [weak self] result in
